...
module NLG =
    ...
    let helloPhrases = [
        "Welcome!"
        "Welcome, my name is Mina."
        "Welcome to Mina. How can I help?"
        "Hello this is Mina, how can I help?"
        "Hello, I am Mina. How can I help?"
        "Hello, I am Mina. How may I help you now?"
        "I'm Mina. Tell me your name so we can get started."
    ]
