...
using Mina.NLU.GoogleHC;
using Mina.NLU.ExpertAI;
using Mina.FHIR;
...
namespace Mina.CLI
{
    class Program : Runtime
    {
        ...
        {
            CO.WriteLine(FiggleFonts.Chunky.Render("Mina"), Color.Red);
        ...
        {
            Error((Exception)e.ExceptionObject, "Unhandled error occurred during operation. Mina CLI will now shutdown.");
