...
using Mina.NLU.GoogleHC.Models;

namespace Mina.NLU.GoogleHC
{
    public class GoogleHCApi : Runtime
    {
        ...
        public static async Task<ApiResponse> AnalyzeEntities2(string document)
        {
            string r = await AnalyzeEntities(document);
            return JsonConvert.DeserializeObject<ApiResponse>(r);
        }
        #endregion
