...
namespace Mina.FHIR
{
    public class GoogleHCFHIR3Client : FHIR3Client
    {
        ...
        public GoogleHCFHIR3Client(): base("https://healthcare.googleapis.com/v1/projects/seismic-bonfire-319022/locations/us-central1/datasets/Mina/fhirStores/1/fhir/")
        {
