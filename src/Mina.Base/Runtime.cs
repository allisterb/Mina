...
namespace Mina
{
    public abstract class Runtime
    {
        ...
        static Runtime()
        {
            ...
            else if (Assembly.GetEntryAssembly().GetName().Name == "Mina.CLI" && Environment.GetEnvironmentVariable("USERNAME") == "Allister")
            {
                Configuration = new ConfigurationBuilder()
            ...
            else if (Assembly.GetEntryAssembly().GetName().Name == "Mina.Web" && Environment.GetEnvironmentVariable("USERNAME") == "Allister")
            {
                Configuration = new ConfigurationBuilder()
                    .AddUserSecrets("f3ed0dc7-f978-44ae-8add-9e5bfcf8fa8a")
                    .Build();
            ...
            HttpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Mina/0.1");
        }
